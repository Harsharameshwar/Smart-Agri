...
import com.gascitech.smartagri.service.MyUserDetailsService;
...
//		System.out.println(Arrays.stream(cook)
...
//				jwt=EncrypterHelper.decrypt(jwt);
			...
			if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
				...
				if (jwtUtil.validateToken(jwt, userDetails,request) && jwtUtil.vadidatelogout(jwt)) {
